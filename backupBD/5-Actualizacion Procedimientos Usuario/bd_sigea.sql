...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2022 a las 08:03:32
...
SELECT `dni_usuario`, `nombre_usuario`,`email_usuario` FROM `tb_usuario` WHERE `estado_usuario`=1 AND `dni_usuario`=_dni_usuario AND `clave_usuario`=_clave_usuario LIMIT 1;
END$$
...
(1, '123456789', 'Cleto González Víquez', 'correo@correo.com', '12345678', 1),
